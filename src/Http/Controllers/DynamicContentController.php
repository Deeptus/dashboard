...
class DynamicContentController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        $section = $item->section;
        $item->delete();
        return redirect()->route('Dashboard::admin.dynamic-content', [$section])->with('status', 'Se elimino un <strong>item</strong> del slider con éxito.');
    }
    ...
    public function restore($id)
    {
        ...
        $item->save();
        return redirect()->route('Dashboard::admin.dynamic-content.trash', [$section])->with('success', 'Se ha restaurado un <strong>item</strong> con éxito.');
    }
    public function copy($id)
    {
        ...
        $section = $new->section;
        $new->save();
        return redirect()->route('Dashboard::admin.dynamic-content.edit', $new->id)->with('success', 'Se ha duplicado un <strong>item</strong> con éxito.');
    }
}
