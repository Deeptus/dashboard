...
class TranslationController extends Controller
{
    ...
    public function store(Request $request, Translation $item)
    {
        ...
        $item->save();
        return redirect()->route('Dashboard::admin.translation')->with('success', 'Se añadio una <strong>Traducción</strong> con éxito.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $item->translation = $request->translation;
        $item->save();
        return redirect()->route('Dashboard::admin.translation')->with('success', 'Se ha editado una <strong>Traducción</strong> con éxito.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('Dashboard::admin.translation')->with('success', 'Se ha eliminado una <strong>Traducción</strong> con éxito.');
    }
    ...
    public function restore($id)
    {
        ...
        $item->save();
        return redirect()->route('Dashboard::admin.translation.trash')->with('success', 'Se ha restaurado un <strong>Traducción</strong> con éxito.');
    }
}
