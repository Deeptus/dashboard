        ...
        <table class="data_table table table-striped table-bordered display">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if (!$item->trashed())
                        <a href="{{ route('admin.user.edit', [$item->getKey()]) }}" class="btn btn-primary btn-sm">
                            <i class="fas fa-sm text-white-50 fa-edit"></i>
                            Editar
                        </a>
                        @if (2==3)
                        <a href="{{ route('admin.user.permission', [$item->getKey()]) }}" class="btn btn-warning btn-sm">
                            <i class="fas fa-sm text-white-50 fa-key"></i>
                            Permisos
                        </a>
                        @endif
                        <a href="{{ route('admin.user.destroy', [$item->getKey()]) }}" class="btn btn-danger btn-sm">
                            <i class="fas fa-sm text-white-50 fa-trash-alt"></i>
                            Eliminar
                        </a>
                        @else
                        <a href="{{ route('admin.user.restore', [$item->getKey()]) }}" class="btn btn-warning btn-sm">
